...
# 构建点云
def identifyOverlap(cat2_list, image_number = 4, p_type = "POINT", time_moment = 20, noise_length = 2,
                   write_path= None, read_path=None,
                   save_point_clound=True,
                   hough_npoints=3, lines_npoints=4, track="OBJECT"):
    ...
    # 直线决策与输出
    status3, error3, lines_list = ol.judge_output_lines(point_clound, file_lines, trail_time, vec, lines_npoints, track)
    if status3 != 0:
