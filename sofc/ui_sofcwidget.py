...
################################################################################
## Form generated from reading UI file 'sofcwidget.ui'
##
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.btn_file.setMaximumSize(QSize(30, 16777215))
        ...
        self.verticalLayout_3.addWidget(self.cb_8)
        ...
        self.cb_dir_model = QCheckBox(Form)
        self.cb_dir_model.setObjectName(u"cb_dir_model")

        self.horizontalLayout_4.addWidget(self.cb_dir_model)
    ...
    def retranslateUi(self, Form):
        ...
        self.label_3.setText(QCoreApplication.translate("Form", u"\u8f93\u5165\u6587\u4ef6:", None))
        self.btn_file.setText(QCoreApplication.translate("Form", u"...", None))
        ...
        self.cb_7.setText(QCoreApplication.translate("Form", u"\u970d\u592b\u53d8\u6362", None))
        self.cb_8.setText(QCoreApplication.translate("Form", u"\u5b54\u5f84\u6d4b\u5149", None))
        self.cb_all.setText(QCoreApplication.translate("Form", u"\u5168\u9009", None))
        self.cb_dir_model.setText(QCoreApplication.translate("Form", u"\u8def\u5f84\u6a21\u5f0f", None))
